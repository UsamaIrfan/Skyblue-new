...
const ProductSkull = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <View>
            <Rect x={"20"} y="60" rx="5" ry="5" width={width - 50} height="100" />
            <Rect x={"20"} y="170" rx="5" ry="5" width={width - 50} height="30" />
            <Rect x={"20"} y="210" rx="5" ry="5" width={width / 3} height="20" />
        </View>
        
        <View>
            <Rect x={"20"} y="260" rx="5" ry="5" width={width - 50} height="100" />
            <Rect x={"20"} y="370" rx="5" ry="5" width={width - 50} height="30" />
            <Rect x={"20"} y="410" rx="5" ry="5" width={width / 3} height="20" />
        </View>
        
        <View>
            <Rect x={"20"} y="460" rx="5" ry="5" width={width - 50} height="100" />
            <Rect x={"20"} y="570" rx="5" ry="5" width={width - 50} height="30" />
